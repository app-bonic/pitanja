            ...
            switch (vrsta) {
                case "PREDAVANJE":
                    ...
                    eventCard.onclick = () => {
                        ...
                        const url = `details.html?title=${encodeURIComponent(naslovHR)}&speaker=${encodeURIComponent(moderator)}&time=${encodeURIComponent(vrijeme)}&location=${encodeURIComponent(dvorana)}&description=${encodeURIComponent(sažetak)}`;
